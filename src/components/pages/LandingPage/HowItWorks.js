        ...
        <div className="mt-20 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="shadow-2xl p-6 rounded-3xl transition-all hover:scale-110">
            ...
            <p className="text-gray-500 mb-6">
              To start using The Bidder's Block, you'll need to create an account.
          ...
          <div className="shadow-2xl p-6 rounded-3xl transition-all hover:scale-110">
            ...
            <p className="text-gray-500 mb-6">
              Once you're logged in, you can browse all of the auctions available
              on The Bidder's Block.
            </p>
          </div>
          ...
          <div className="shadow-2xl p-6 rounded-3xl transition-all hover:scale-110">
            ...
            <p className="text-gray-500 mb-6">
              When you find an auction you're interested in, you can place a bid.
            </p>
          </div>
